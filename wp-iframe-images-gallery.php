...
<div class="wrap">
  <?php
  	global $wpdb;
    $title = __('iFrame Images Gallery');
        ...
        <td height="35" align="left" valign="bottom"><table width="100%">
            <tr>
              <td align="left"><input name="publish" lang="publish" class="button-primary" value="<?php echo $submittext?>" type="submit" />
                <input name="publish" lang="publish" class="button-primary" onclick="iframe_redirect()" value="Cancel" type="button" /></td>
            </tr>
          </table></td>
      </tr>
  ...
  Short code : [IFRAMEIMAGES:GROUP=Group1:W=600:H=220] <br />
...
<h2>Plugin help</h2>
<ul>
    <li>Plugin created by <a href="http://www.gopiplus.com/work/2011/07/24/wordpress-plugin-wp-iframe-images-gallery/" target="_blank">www.gopiplus.com</a></li>
    <li><a href="http://www.gopiplus.com/work/2011/07/24/wordpress-plugin-wp-iframe-images-gallery/" target="_blank">Click here for more help.</a></li>
    <li><a href="http://www.gopiplus.com/work/2011/07/24/wordpress-plugin-wp-iframe-images-gallery/" target="_blank">Click here for live demo.</a></li>
</ul>
